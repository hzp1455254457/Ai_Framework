...
- 🏗️ **抽象接口架构**：接口与实现完全解耦，支持多种实现（Native、LangChain、LangGraph）灵活切换和组装
- 🔧 **工厂模式**：通过工厂类根据配置创建不同实现，支持依赖注入和组件组装
- 🔗 **完整LangChain集成**：完整的LangChain适配器实现，支持工具转换、记忆转换、多种Agent类型
...
- [架构方案文档](AI框架架构方案文档.md) - 项目架构和技术选型（包含抽象接口架构说明）
- [重构后架构文档](docs/architecture/refactored-architecture.md) - v2.0 新架构设计
- [抽象接口使用指南](docs/guides/abstract-interface-usage.md) - 抽象接口架构使用方法和示例
- [LangChain使用指南](docs/guides/langchain-usage.md) - LangChain集成使用方法和示例
- [LangChain迁移指南](docs/guides/langchain-migration.md) - 从Native迁移到LangChain实现
